...
const AddProductForm: React.FC<AddProductFormProps> = ({ data }) => {
  ...
  useEffect(() => {
    const totalProductPrice = () => {
      const extrasPrice =
        form.getValues("extras")?.reduce((acc, item) => acc + item.price, 0) ||
        0;
            ...
            <FormItem>
              ...
              <FormControl>
                <div className="flex flex-row justify-center sm:justify-start gap-4">
                  ...
                  <div className="flex items-center justify-center border border-input rounded-md w-10">
