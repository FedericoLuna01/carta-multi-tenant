    ...
    >
      {
        product.isPromo && (
          <div
            className="absolute top-0 right-0 bg-green-600 text-white text-xs px-12 py-2 translate-y-1 translate-x-8 rotate-[30deg] z-10 font-semibold"
          >
            Promo
          </div>
        )
      ...
      <div
        className="h-[210px] w-auto lg:w-1/3 flex-shrink-0 relative"
      >
        <Image
          src={product.image}
          alt="food"
      ...
      <div
        className="w-full flex flex-col justify-between h-full lg:h-auto"
      >
        <CardHeader>
          <CardTitle
        ...
        >
          ...
          >
            <p
              className={`font-semibold text-[1rem] ${product.isPromo ? 'text-gray-500 line-through' : 'text-slate-800'}`}
            >
